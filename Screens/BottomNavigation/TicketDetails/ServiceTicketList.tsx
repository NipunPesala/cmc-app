...
import { getServiceTicketList } from '../../../SQLiteDatabaseAction/DBControllers/TicketController';
import { getTicketsForInprogress } from '../../../SQLiteDatabaseAction/DBControllers/TicketController';
import { getAllTickets } from "../../../SQLiteDatabaseAction/DBControllers/TicketController";
...
const InprogressTask = () => {
    ...
    return (
        ...
        <SafeAreaView style={comStyles.CONTAINER}>
            <Header isBtn={true} title="Service Tickets List" btnOnPress={() => navigation.goBack()} />
                                    ...
                                    return (
                                        <View style={{ width: '100%', padding: 10, alignItems: 'center' }}>
                                            <ListBox
                                                ...
                                                name={"Service Call ID: "+item.startDate}
